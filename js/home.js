...
const options = {
  ...
  fetch('https://api.themoviedb.org/3/genre/movie/list?language=en', options)
   ...
   const fetchMoviesListByGenres = (id, genres) => {
    ...
    // Updated API URL to fetch movies based on genre ID
    fetch(`https://api.themoviedb.org/3/discover/movie?with_genres=${id}&include_adult=false&include_video=false&language=en-US&page=1&sort_by=popularity.desc`, options)
        .then(res => res.json())
        .then(data => {
